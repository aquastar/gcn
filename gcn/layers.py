...
class GraphConvolution_Rational_Element(Layer):
    ...
    def __init__(self, input_dim, output_dim, placeholders, dropout=0.,
        ...
        with tf.variable_scope(self.name + '_vars'):
            self.vars['weights'] = ones([1, FLAGS.max_degree + 1], name='weights')
            self.vars['weights_de'] = ones([1, FLAGS.max_degree + 1], name='weights_de')
            ...
            # b1 = 3.29206329e+01
            # b2 = 5.87276401e+01
            # rat_base = (+.0000843879042 + 9.05976227x+60.8403085x ^ 2+ 25.0256727x ^ 3-2.28537321x ^ 4) / (1 + 32.9206329 x+ 58.7276401x ^ 2)
